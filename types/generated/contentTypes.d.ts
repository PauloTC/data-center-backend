...
export interface ApiInvestigationInvestigation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    date: Attribute.Enumeration<['Q1 2024', 'Q2 2024', 'Q3 2024', 'Q4 2024']>;
    status: Attribute.Enumeration<['en curso', 'finalizado']> &
      Attribute.DefaultTo<'en curso'>;
    ...
    >;
    scope: Attribute.Enumeration<['macro', 'mixto', 'puntual']>;
...
export interface ApiResearchResearch extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::research.research', 'name'>;
    phase: Attribute.Integer & Attribute.DefaultTo<1>;
    business: Attribute.Enumeration<
      ['B2B', 'D\u00EDa D\u00EDa', 'Nitro', 'Mayoristas', 'Transversal']
    >;
    business_line: Attribute.Enumeration<['PANI', 'GASTRO', 'LAVAN']>;
    distric: Attribute.Enumeration<['VES', 'SMP', 'Miraflores', 'Surco']>;
    interviewers: Attribute.Enumeration<
      ['suzette bermudez', 'valeria wong', 'rena aguirre', 'sebas sanchez']
    >;
    user_type: Attribute.Enumeration<
      ['cliente', 'ffvv', 'gerente', 'analista']
    >;
    researchers: Attribute.Relation<
      'api::research.research',
      'oneToMany',
...
export interface ApiSubscriberSubscriber extends Schema.CollectionType {
  ...
  attributes: {
    ...
    email: Attribute.Email;
    document_number: Attribute.BigInteger;
    business: Attribute.Enumeration<
      ['bodega', 'restaurante', 'panader\u00EDa', 'chifa', 'mayorista', 'otros']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
